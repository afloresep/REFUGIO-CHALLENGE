# Generated ablation: no-shared-brain-cached-world
# Source baseline: solutions/public/c15da13c3eaa.py
# Hypothesis: Measure loss from removing persistent robot-planner state while keeping static map and distance caching.
