# Generated ablation: no-edge-reservations
# Source baseline: solutions/public/c15da13c3eaa.py
# Hypothesis: Measure whether rolling edge-swap reservations add throughput beyond shared state, cell reservations, flow bias, seed config, and first-step conflict resolution.
