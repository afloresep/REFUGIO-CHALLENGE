# Generated ablation: no-flow-penalty
# Source baseline: solutions/public/c15da13c3eaa.py
# Hypothesis: Measure whether soft one-way lane bias improves throughput or only changes tie-breaking.
...
DEFAULT_CFG = (34, 0.0)     # ablation: disable soft one-way flow bias
