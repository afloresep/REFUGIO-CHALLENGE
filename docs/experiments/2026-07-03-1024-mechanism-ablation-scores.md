...
- Add a combined "general 1024 planner, no suffix hacks" ablation by disabling forced actions, robot boosts, and pickup-side retargeting together.
- Isolate retuned `SEED_CONFIGS` versus the public 1008 settings.
- Use the 1021 no-forced-actions variant as the cleaner base for future layout search.
